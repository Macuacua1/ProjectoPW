...
?>
    ...
    <div class="container"  margin-top="180">           
...
<?php   
      $sql = 'select a.designacao,r.quant,a.preco_unitario,c.nome, f.nome from foto f join artigo a on a.cod_artigo=f.cod_artigo join reserva r on a.cod_artigo=r.cod_artigo join cliente c on r.cod_cliente=c.cod_cliente';
        $resultado = $conexao->query($sql);
        echo
        '<table  id="datatable" class="table table-striped table-bordered">
          <thead>
              <tr>
            <th>BI</th> <th>Foto</th> <th>Designação</th>  <th>Quantidade</th> <th>Preço Unitário</th>
             <th>Cliente</th> <th>Quart.</th>  <th>Av./Rua</th>   <th>Nr_casa</th>   <!--<th>Actions</th>-->
          </tr>
          </thead>';
        if ($resultado->num_rows > 0) {
          ...
          <td> <img src="../Imagens/'.$row[nome].'"></td> 
               <!-- <td class="actions">
                                                    <a href="#">
