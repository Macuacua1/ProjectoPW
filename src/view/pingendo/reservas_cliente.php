              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php   
					      $sql = 'select a.designacao,r.quant,a.preco_unitario,c.nomecli, f.nome from foto f join artigo a on a.cod_artigo=f.cod_artigo join reserva r on a.cod_artigo=r.cod_artigo join cliente c on r.cod_cliente=c.cod_cliente';
