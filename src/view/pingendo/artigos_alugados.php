        ...
        <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class=" col-md-12">
                    <span class="section"><em><h2 align="center">Reservas feitas</h2></em></span>

					<?php   
					      $sql = 'select a.designacao,r.quant,a.preco_unitario,c.nomecli, f.nome from foto f join artigo a on a.cod_artigo=f.cod_artigo join reserva r on a.cod_artigo=r.cod_artigo join cliente c on r.cod_cliente=c.cod_cliente where cod_utilizador=($check="select * from utilizador u inner join cliente c on u.cod_utilizador=c.cod_utilizador WHERE u.username='$user'")';
					        $resultado = $conexao->query($sql);
					        echo
					        '<table  id="datatable" class="table table-striped table-bordered">
					          <thead>
					              <tr>
					            <th>Foto</th> <th>Designação</th>  <th>Quantidade</th> <th>Preço Unitário</th>
					             <th>Cliente</th>    <!--<th>Actions</th>-->
					          </tr>
					          </thead>';
					        if ($resultado->num_rows > 0) {
					            ...
					            while($row = $resultado->fetch_assoc()) {
					          	...
					          	?>
					          	<td><?php echo "<img src=../../../Imagens/$row[nome] >";?></td>
