        ...
        <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class=" col-md-12">
                    <span class="section"><em><h2 align="center">Listagem de Clientes </h2></em></span>


<?php
      
      $sql = "SELECT * FROM cliente c inner join endereco e where c.cod_endereco=e.cod_endereco";
        ...
        '<table  id="datatable" class="table table-striped table-bordered">
          <thead>
             ...
             <th>Bairro</th> <th>Quart.</th>  <th>Av./Rua</th>   <th>Nr_casa</th>   <!--<th>Actions</th>-->
          </tr>
          </thead>';
