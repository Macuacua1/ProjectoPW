...
<html lang="en">
  <head>
    ...
    <title>Registo de Funcionario | </title>
...
<style type="text/css">
 ...
 <div class="navbar navbar-fixed-top" role="navigation" data-0="line-height:100px; height:100px; background-color:rgba(0,0,0,0.3);" data-300="line-height:60px; height:60px; background-color:rgba(0,0,0,1);">
            ...
            <li>
              <a href="registo.html">Registe-se</a>
            </li>
            <li>
            ...
            <li>
              ...
              <li><button type="button" class=" btn btn-sucess" data-toggle="modal" data-target="#popUpWindow">Login</button></li>
                    </ul>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal " method="post" action="registarFuncionario.php" novalidate>
                      ...
                      <div class=" col-md-4">
                       <span class="section"><em><h2 align="center">Registo do Funcionario</h2></em></span>
                     ...
                     <div class=" col-md-6">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bi">BI <span class="obrigatorio">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="bi" type="text" name="bi" required="required"  class="optional form-control col-md-7 col-xs-12">
                        </div>
                      </div>
